...
function setNewParameters() {
	document.getElementById("newxstop").value = deltaParams.xstop.toFixed(0);
	document.getElementById("newystop").value = deltaParams.ystop.toFixed(0);
	document.getElementById("newzstop").value = deltaParams.zstop.toFixed(0);
...
function generateCommands() {
	...
	document.getElementById("commands").value = commands;
		$.ajax( { type : 'POST',
          ...
          data : {M663:m663,M664:m664,M665:m665},
          url  : 'js/upload.php',              
